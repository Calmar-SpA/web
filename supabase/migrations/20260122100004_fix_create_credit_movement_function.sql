-- Corregir función para crear movimiento de venta a crédito B2B
-- Agregar manejo de excepciones para capturar errores del trigger de inventario
...
BEGIN
  ...
  -- Insertar el movimiento (puede fallar si el trigger de inventario tiene problemas)
  BEGIN
...
COMMENT ON FUNCTION public.create_credit_sale_movement IS 'Crea un movimiento de venta a crédito B2B con manejo de errores.';
