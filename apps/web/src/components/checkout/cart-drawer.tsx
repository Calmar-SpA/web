          ...
          <div className="p-6 border-t space-y-4 bg-slate-50/50">
            <div className="space-y-2">
              ...
              <div className="flex justify-between text-lg pt-2 border-t border-slate-200">
                ...
                <span className="font-black italic text-calmar-ocean">${total.toLocaleString('es-CL')}</span>
              </div>
            </div>
            
            <Link href="/checkout" className="block w-full">
              <Button className="w-full h-14 bg-slate-900 hover:bg-calmar-ocean text-white font-black italic shadow-lg shadow-slate-900/20 transition-all active:scale-95">
                INICIAR COMPRA
              </Button>
            </Link>
